...
<body >
	...
	<div >
		<div >
			...
			<div>
				<div>
					<a href="admin_course_add.jsp"> 增加一个课程信息</a>
						...
						<table width="100%">
							...
							<c:forEach items="${page.recordList}" var="pm" varStatus="i">
								<tr>
									...
									<td>${pm.credit}</td>
									<td>
										<a href="GetCourseToUpdateServlet?cno=${pm.cno }&tokenStr=${sessionScope.CONTROL_REFRESH }&pageNum=${page.currentPageNum}">修改</a>
										<a href="DeleteCourseServlet?cno=${pm.cno }&tokenStr=${sessionScope.CONTROL_REFRESH }&pageNum=${page.currentPageNum}">刪除</a>
									</td>
								</tr>
							</c:forEach>
						</table>
